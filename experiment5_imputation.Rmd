...
prop_mis_test = list(c(0, 0, 0, 0),
                     c(0, 0, 0, 0), 
                     c(0, 0, 0, 0))
res1 = experiment_missing_data(prop_mis_train, prop_mis_test, H, d, type, R, max_iter = 3000, n_irrelevant_features = 0, continuous = FALSE, n_rep = 10)
...
prop_mis_test = list(c(0, 0, 0, 0),
                     c(0, 0, 0, 0), 
                     c(0, 0, 0, 0))
res2 = experiment_missing_data(prop_mis_train, prop_mis_test, H, d, type, R, max_iter = 3000, n_irrelevant_features = 0, continuous = FALSE, n_rep = 10)
...
prop_mis_test = list(c(0, 0, 0, 0),
                     c(0, 0, 0, 0), 
                     c(0, 0, 0, 0))
res3 = experiment_missing_data(prop_mis_train, prop_mis_test, H, d, type, R, max_iter = 3000, n_irrelevant_features = 0, continuous = FALSE, n_rep = 10)
